            ...
            <div class="ai-tools-grid">
                ...
                <div class="ai-tool-card">
                    <div class="ai-tool-header">
                        ...
                        <?php endif; ?>
                        <h3><?php echo htmlspecialchars($tool['name']); ?></h3> <!-- Egennavn fra array -->
                    </div>
                    <div class="ai-tool-features">
                        <?php foreach ($tool['features'] as $feature): ?>
                        <div class="ai-feature-item">
                            <h4><?php echo htmlspecialchars($feature['title']); ?></h4> <!-- Fra array, satt til sentence case i index.php -->
