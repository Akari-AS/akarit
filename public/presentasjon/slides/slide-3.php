<section id="slide-3" class="slide bg-lys">
     <div class="text-center max-w-5xl w-full">
        <h2 class="text-4xl md:text-6xl font-bold text-teal-dark mb-12">Vi bygger digitale vinnere – fra <em>fasade</em> til <em>maskinrom</em></h2>
        <div class="grid md:grid-cols-2 gap-8 items-center">
            <div class="bg-glacier p-8 rounded-lg text-center">
                <h3 class="text-3xl font-bold text-teal-dark">Fasaden: Deres <strong>ansikt utad</strong></h3>
            ...
            <div class="bg-teal-dark text-white p-8 rounded-lg text-center fragment">
                <h3 class="text-3xl font-bold mb-4">Maskinrommet: Deres <strong>interne motor</strong></h3>
