...
<section id="nrk-google-workspace">
    <div class="container">
        <h2>NRK Velger Google Workspace: Et Tegn i Tiden</h2>
        ...
        <div class="nrk-story-container">
            ...
            <h3>Hør vår Podcast om Overgangen</h3>
            ...
            <!-- 
                Alternativ for WAV-fil hvis du har den og ønsker å bruke den:
                Du kan legge til en mappe som /public/assets/audio/
                <audio controls style="width: 100%;">
                    <source src="/assets/audio/din-podcast-fil.wav" type="audio/wav">
                    Din nettleser støtter ikke audio-elementet.
                </audio>
                Husk å laste opp .wav-filen til serveren.
            -->
        </div>
    </div>
</section>
