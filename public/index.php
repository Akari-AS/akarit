...
$pageTitle = 'Google Workspace for Bedrifter | Akari'; // Endret fra Akarit
$pageDescription = 'Styrk bedriften med Google Workspace. Akari tilbyr ekspertise.'; // Endret fra Akarit
