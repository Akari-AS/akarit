<?php
// Lokasjoner for Innlandet-regionen
return [
    'hamar' => [
        'name' => 'Hamar',
        'heroText' => "Akari i Hamar: Din partner for Google Workspace. Vi hjelper bedrifter i Mjøsregionen med skybasert produktivitet og samarbeid.",
        'metaDescription' => "Google Workspace-ekspertise i Hamar. Akari tilbyr skreddersydde skyløsninger og lokal support.",
    ],
    'lillehammer' => [
        'name' => 'Lillehammer',
    ...
    'elverum' => [
        'name' => 'Elverum',
        'heroText' => "Effektiviser driften i Elverum med Google Workspace fra Akari. Vi tilbyr support og skreddersydde løsninger for Østerdalen.",
        'metaDescription' => "Google Workspace-spesialist i Elverum. Akari hjelper din bedrift med overgang, support og AI-verktøy.",
    ],
    'kongsvinger' => [
        'name' => 'Kongsvinger',
