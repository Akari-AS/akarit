<?php
// Lokasjoner for Trøndelag-regionen
return [
    'trondheim' => [
        'name' => 'Trondheim',
        'heroText' => "Akari i Trondheim: Din partner for Google Workspace. Vi hjelper teknologihovedstadens bedrifter med skybasert produktivitet.",
        'metaDescription' => "Google Workspace-ekspertise i Trondheim. Akari tilbyr skreddersydde skyløsninger og lokal support.",
    ],
    'steinkjer' => [
        'name' => 'Steinkjer',
    ...
    'namsos' => [
        'name' => 'Namsos',
        'heroText' => "Effektiviser driften i Namsos med Google Workspace fra Akari. Vi tilbyr support og skreddersydde løsninger for Namdalen.",
        'metaDescription' => "Google Workspace-spesialist i Namsos. Akari hjelper din bedrift med overgang, support og AI-verktøy.",
    ],
    'levanger' => [
        'name' => 'Levanger',
        'heroText' => "Akari leverer Google Workspace til bedrifter i Levanger. Oppdag fordelene med sømløst samarbeid i skyen.",
        'metaDescription' => "Lokal ekspertise på Google Workspace i Levanger. Akari er din partner for digitale løsninger.",
    ],
    'verdal' => [
        'name' => 'Verdal',
